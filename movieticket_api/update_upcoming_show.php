...
$query = "UPDATE `upcoming_shows` SET `screenno`= '$screenno',`total_seats`= '$total_seats',`booked_seats`= '$booked_seats',`price`= '$price',`timing`='$timing',`date`='$data',`movie_caption`='$movie_caption',`movie_image`='movie_image', WHERE `moviename`='$moviename'";
